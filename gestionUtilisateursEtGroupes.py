...
# Fonction pour la gestion d'un fichier de logs, celui-ci est créé dans le dossier courant. Option "a" = append, "w" = overwrite
def modify_log_file(text_to_append, filename, option):
